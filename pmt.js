var taskObj = {
    ...
    populateTaskDropdown: function() {
    
        var tasks = ["Car booking","Restaurant Website", "Online Appointment Booking", "Digital Library", "Online Food Delivery","Shopping Website"]; 
